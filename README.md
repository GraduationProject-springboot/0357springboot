...
# 0357springboot智慧社区居家养老健康管理系统pf

![picture](https://raw.githubusercontent.com/GraduationProject-springboot/.github/main/img/wx.png)

### 点击播放视频 ▼
[![Watch the video](https://i.sstatic.net/Vp2cE.png)](https://www.bilibili.com/video/BV1T1bpekEK7?p=29)


# 第1章 绪论
## 1.1选题动因
当前的网络技术，软件技术等都具备成熟的理论基础，市场上也出现各种技术开发的软件，这些软件都被用于各个领域，包括生活和工作的领域。随着电脑和笔记本的广泛运用，以及各种计算机硬件的完善和升级，市面上的电脑和笔记本的性能都得到提升，可以支持的软件也逐渐增多，因此，在计算机上安装软件来发挥其高效地信息处理的作用，则很受人们的青睐。对于智慧社区居家养老健康管理系统信息来讲，通过手工形式处理，在面对庞大的信息数量时，就显得不适宜了，首先需要花费的时间比较多，其次数据出错率比较高，而且对错误的数据进行更改也比较困难，最后，检索数据费事费力。因此，为了解决上述问题，有必要建立智慧社区居家养老健康管理系统，来规范智慧社区居家养老健康管理系统信息管理流程，让管理工作可以系统化和程序化，同时，智慧社区居家养老健康管理系统的有效运用可以帮助管理人员准确快速地处理信息。
## 1.2目的和意义
智慧社区居家养老健康管理系统可以对智慧社区居家养老健康管理系统信息进行集中管理，可以真正避免传统管理的缺陷。智慧社区居家养老健康管理系统是一款运用软件开发技术设计实现的应用系统，在信息处理上可以达到快速的目的，不管是针对数据添加，数据维护和统计，以及数据查询等处理要求，智慧社区居家养老健康管理系统都可以轻松应对。所以，智慧社区居家养老健康管理系统的运用是让智慧社区居家养老健康管理系统信息管理升级的最好方式。它可以实现信息处理的便利化要求，还可以规范信息处理的流程，让事务处理成为管理人员手中的一件简单事，而不是之前手工处理时的困难事。尽管智慧社区居家养老健康管理系统具备较完善的功能，但是也需要管理人员利用闲暇时间提升自身素质以及个人能力，在操作智慧社区居家养老健康管理系统时可以最大化运用智慧社区居家养老健康管理系统提供的功能，让系统在满足高效率处理数据的同时，也能始终稳定运行，还可以确保数据的可靠性与数据处理的质量。
## 1.3论文结构安排
...
# 第2章 开发环境与技术
开发智慧社区居家养老健康管理系统需要搭建编程的环境，也需要通过调查，对各个相关技术进行分析，选取适合本系统开发的技术与工具。
## 2.1 MYSQL数据库
...
图3.3 查询信息流程图
## 3.3系统性能分析
分析智慧社区居家养老健康管理系统对于性能的需求主要还是从下面的5个角度来分析，它们分别是系统的实用性，系统的适应性，系统的易操作性，系统的安全性和系统的易维护性。
...
![C:/Users/Administrator/Desktop/temp111\1\img\社区工作人员.jpg](/md/blog.005.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\社区工作人员.jpg")
社区工作人员实体属性图

（2）下图是家属实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\家属.jpg](/md/blog.006.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\家属.jpg")
家属实体属性图

（3）下图是服务项目信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\服务项目信息.jpg](/md/blog.007.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\服务项目信息.jpg")
服务项目信息实体属性图
...
![C:/Users/Administrator/Desktop/temp111\1\img\档案信息.jpg](/md/blog.009.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\档案信息.jpg")
档案信息实体属性图

（6）下图是医生预约实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\医生预约.jpg](/md/blog.010.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\医生预约.jpg")
医生预约实体属性图

（7）下图是老人实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\老人.jpg](/md/blog.011.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\老人.jpg")
老人实体属性图

（8）下图是事宜信息实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\事宜信息.jpg](/md/blog.012.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\事宜信息.jpg")
事宜信息实体属性图

（9）下图是医生实体和其具备的属性。

![C:/Users/Administrator/Desktop/temp111\1\img\医生.jpg](/md/blog.013.jpeg "C:/Users/Administrator/Desktop/temp111\1\img\医生.jpg")
医生实体属性图
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|daibanshiyi\_name|String|事宜标题|是|
|3|daibanshiyi\_types|Integer|事宜类型|是|
|4|gongzuorenyuan\_id|Integer|工作人员|是|
|5|daibanshiyi\_photo|String|事宜封面|是|
|6|daibanshiyi\_content|String|事宜简介|是|
|7|daibanshiyi\_delete|Integer|逻辑删除|是|
...
|5|fuwuxiangmu\_content|String|服务项目简介|是|
...
|4|gongzuorenyuan\_phone|String|联系方式|是|
|5|gongzuorenyuan\_email|String|电子邮箱|是|
|6|gongzuorenyuan\_delete|Integer|逻辑删除|是|
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiankangdangan\_name|String|档案标题|是|
|3|jiankangdangan\_types|Integer|档案类型|是|
|4|jiankangdangan\_file|String|档案下载|是|
|5|yonghu\_id|Integer|老人|是|
|6|jiankangdangan\_content|String|档案详情|是|
|7|jiankangdangan\_delete|Integer|逻辑删除|是|
|8|insert\_time|Date|添加时间|是|
|9|create\_time|Date|创建时间|是|
表4.6家属表
...
| :-: | :-: | :-: | :-: | :-: |
|1|Id|Int|id|否|
|2|jiashu\_name|String|家属姓名|是|
|3|jiashu\_photo|String|头像|是|
|4|jiashu\_phone|String|联系方式|是|
|5|jiashu\_email|String|电子邮箱|是|
|6|shenfen\_types|Integer|身份|是|
|7|yonghu\_id|Integer|老人|是|
|8|jiashu\_delete|Integer|逻辑删除|是|
|9|create\_time|Date|创建时间|是|
表4.7公告信息表
...
|9|yisheng\_guahao|String|预约须知|是|
...
|3|yonghu\_id|Integer|老人|是|
|4|yisheng\_yuyue\_time|Date|预约时间|是|
|5|yisheng\_yuyue\_text|String|预约备注|是|
|6|yisheng\_yuyue\_yesno\_types|Integer|预约审核|是|
|7|yisheng\_yuyue\_yesno\_text|String|审核结果|是|
|8|create\_time|Date|创建时间|是|
表4.10老人表
...
|7|yonghu\_age|Integer|年龄|是|
|8|jiankang\_types|Integer|健康指标|是|
